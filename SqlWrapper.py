...
class SqlWrapper:
    ...
    def __init__(self, testEnvironment, test_db_name):
        self.datadump = DataDump.DataDump(testEnvironment)
    ...
    def create_table_weapons(self):
        ...
        SqlQuery = ("""create  table Weapons(weapon text NOT NULL Primary KEY, reload_speed
    ...
    def create_table_engines(self):
        ...
        SqlQuery = ("""create  table engines(engine text NOT NULL Primary KEY, power int[notNULL], 
    ...
    def insert_hull_details(self):
        for hull in self.datadump.Shiphulls:
            ...
            SqlQuery= """insert into hulls (hull, armor, armorType, capacity) 
