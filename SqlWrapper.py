...
class SqlWrapper:
    ...
    def create_table_weapons(self):
        ...
        self.cursor.execute("create  table Weapons(weapon text NOT NULL Primary KEY,reloadSpeed int[not NULL] "
                            "range text[not NULL], powerVolley text[not NULL]count text[not NULL]);")
